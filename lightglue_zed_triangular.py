# TODO: https://temugeb.github.io/opencv/python/2021/02/02/stereo-camera-calibration-and-triangulation.html read this!
...
if crd0.size:
    ...
    ax.scatter(-res_xyz[0], res_xyz[1], res_xyz[2], marker='x')
    ax.scatter((-0.75, 0.75), (0,0), (0,0), marker='o', color='r')
    ...
    if save_figs:
        plt.show()
        # plt.savefig("results/"+date+"_triangulation_"+str(use_contour)+".jpg")
else:
